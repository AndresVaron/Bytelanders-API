...
public class ClasificacionImagenes {
     ...
     */
    public String identificacionPredio(String direccion) throws IOException {
...
//		}
    ...
    public static boolean direccionesRepetidas() {
    ...
    public static String palabrasClave(String direccion) {
    ...
    public static String tipoPredio(double longitud, double latitud) throws IOException {
